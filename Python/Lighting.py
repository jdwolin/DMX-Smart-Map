...
def runTest(td):
    ...
    while n < numLoops:
        ...
        if waitingForReply == True:
            ...
            os.chdir('C://Program Files/AutoHotkey/')
            dataRecvd = recvFromArduino()
            path = "C:\\Users\\Missions\\Dropbox\\FCBC Missions Map\\Light Settings\\" + dataRecvd + ".txt"
            path1 = "C:\\Users\\Missions\\Dropbox\\FCBC Missions Map\\AutoHotkey\\Lighting.ahk" 
            subprocess.call(['AutoHotkeyU64.exe', path1, path])
            n += 1
            waitingForReply = False
